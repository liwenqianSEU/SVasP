...
def parse_args(script):
  ...
  parser.add_argument('--data_dir'    , default='/data/user/dataset', type=str, help='')
  ...
  parser.add_argument('--n_crops', type=int, default=2, help='number of crops')
  parser.add_argument('--n_episode'   , default=120, type=int,  help='episode numbers for each epoch')
  parser.add_argument('--lambd_crop', default=0.2, type=float, help='layer_wise_prob to choose the layer to drop channels')
